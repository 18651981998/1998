    ...
    children: [
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'answer', cn: '答案 回答' },
          { en: 'minus', cn: '减 减号' },
          { en: 'odd numbers', cn: '奇数' },
          { en: 'even numbers', cn: '偶数' },
          { en: 'use', cn: '使用' },
          { en: 'help', cn: '帮助' },
          { en: 'thing', cn: '东西 事物' },
          { en: 'say', cn: '说' },
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'a bag of rice', cn: '一袋米' },
          { en: 'a box of eggs', cn: '一盒鸡蛋' },
          { en: 'a bottle of juice', cn: '一瓶果汁' },
          { en: 'buy', cn: '购买' },
          { en: 'sell', cn: '出售' },
          { en: 'need', cn: '需要' },
    ...
    children: [
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'watch tv', cn: '看电视' },
          { en: 'west', cn: '西方' },
          { en: 'play with friends', cn: '和朋友一起玩' },
          { en: 'capital', cn: '首都' },
          { en: 'have a picnic', cn: '野饕' },
          { en: 'palace', cn: '王宫;宫殿' },
          { en: 'tourist', cn: '游客' },
          { en: 'visit', cn: '参观;拜访' },
          { en: 'northwest', cn: '西北' },
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'cave', cn: '洞穴' },
          { en: 'waterfall', cn: '瀑布' },
          { en: 'eat healthy food', cn: '吃健康的食物' },
          { en: 'drink a lot of water', cn: '多喝水' },
          { en: 'get enough sleep', cn: '保证充足的睡眠' },
          { en: 'strong', cn: '强壮的' },
          { en: 'soon', cn: '很快;马上' },
          { en: 'about', cn: '关于' },
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'a glass of', cn: '一杯' },
          { en: 'me too.', cn: '我也是' },
          { en: 'can\'t wait to go', cn: '我迫不及待要去了!' },
          { en: 'get sunlight', cn: '获取阳光' },
          { en: 'get food and water', cn: '获取食物和水' },
          { en: 'celebrate', cn: '庆祝' },
          { en: 'main', cn: '主要的' },
          { en: 'living', cn: '有生命的' },
          { en: 'eve', cn: '前夕' },
          { en: 'nonliving', cn: '无生命的' },
          { en: 'stocking', cn: '长筒袜' },
          { en: 'visit relatives', cn: '拜访亲戚;探亲' },
          { en: 'air', cn: '空气' },
          { en: 'eat mooncakes', cn: '吃月饼' },
          { en: 'by themselves', cn: '独自地;无外力地' },
          { en: 'have a dragon boat race', cn: '进行龙舟比赛' },
          { en: 'important', cn: '重要的' },
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'put up', cn: '搭建;张贴;挂起' },
          { en: 'dirty', cn: '脏的' },
          { en: 'rubbish', cn: '垃圾' },
          { en: 'recycle', cn: '回收利用' },
          { en: 'reduce', cn: '减少' },
          { en: 'slow', cn: '慢的' },
          { en: 'natural resources', cn: '自然资源' },
          { en: 'excited', cn: '兴奋的' },
          { en: 'call', cn: '叫醒' },
          { en: 'unhappy', cn: '不开心的' },
          { en: 'wood', cn: '木材' },
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'europe', cn: '欧洲' },
          { en: 'london', cn: '伦敦' },
          { en: 'pagoda hill', cn: '宝塔山' },
          { en: 'tower bridge', cn: '伦敦塔桥' },
