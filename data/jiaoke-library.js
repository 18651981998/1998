    ...
    children: [
      {
        ...
        words: [
          ...
          { en: 'also', cn: '也；此外' },
          { en: 'an animal lover', cn: '一个动物爱好者' },
          { en: 'another', cn: '另一个' },
          { en: 'basket', cn: '篮子' },
          { en: 'be picky about food', cn: '挑食' },
          { en: 'between', cn: '在…… 之间' },
          { en: 'bike', cn: '自行车' },
          { en: 'break', cn: '休息，间歇；打破' },
          { en: 'breath', cn: '呼吸' },
          { en: 'bring', cn: '提出；带来' },
          { en: 'bring up the problem', cn: '提出问题' },
          { en: 'build good habits', cn: '养成好习惯' },
          { en: 'building', cn: '建筑物' },
          { en: 'call', cn: '称呼；喊' },
          { en: 'calm down', cn: '冷静，平静下来' },
          { en: 'canteen staff', cn: '食堂员工' },
          { en: 'change', cn: '改变' },
          { en: 'change the menu', cn: '更换菜单' },
          { en: 'cheap', cn: '便宜' },
          { en: 'choose', cn: '选择' },
          { en: 'classmate', cn: '同学' },
        ]
      },
      {
        ...
        words: [
          ...
          { en: 'difference', cn: '不同' },
          { en: 'dig', cn: '挖掘' },
          { en: 'drink enough water', cn: '喝足量的水' },
          { en: 'eat a lot', cn: '吃很多' },
          { en: 'eat snacks', cn: '吃零食' },
          { en: 'either', cn: '也；（两者中的）任何一个' },
          { en: 'far away', cn: '很远' },
          { en: 'fifth', cn: '第五' },
          { en: 'fight with each other', cn: '双方争吵' },
          { en: 'finish', cn: '完成' },
          { en: 'finish homework', cn: '完成作业' },
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'give too much food', cn: '给太多食物' },
          { en: 'glove', cn: '手套' },
          { en: 'go for a walk', cn: '出去走走' },
          { en: 'go to school early', cn: '上学很早' },
          { en: 'habit', cn: '习性，习惯' },
          { en: 'have a new haircut', cn: '剪了个新发型' },
          { en: 'have a sweet tooth', cn: '爱吃甜食' },
          { en: 'helpful', cn: '有帮助的，有益的' },
          { en: 'homework', cn: '作业' },
          { en: 'hospital', cn: '医院' },
          { en: 'important', cn: '重要的' },
          { en: 'joke', cn: '玩笑' },
          { en: 'learn', cn: '学习' },
          { en: 'learn about it', cn: '了解它' },
          { en: 'least', cn: '至少，最少' },
          { en: 'lie', cn: '欺骗，撒谎' },
          { en: 'lion', cn: '狮子' },
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'orange', cn: '橙色的；橙子' },
          { en: 'play', cn: '玩' },
          { en: 'play during the night', cn: '在夜间玩耍' },
          { en: 'playground', cn: '操场' },
          { en: 'please', cn: '请' },
          { en: 'potato', cn: '土豆' },
          { en: 'proud', cn: '骄傲的，自豪的' },
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'shout bad words', cn: '大声骂人' },
          { en: 'sleep during the day', cn: '白天睡觉' },
          { en: 'snack', cn: '零食，小吃' },
          { en: 'solve the problem', cn: '解决问题' },
          { en: 'sometimes', cn: '有时候' },
          { en: 'stay', cn: '停留；保持' },
          { en: 'stay healthy', cn: '保持健康' },
          { en: 'stay inside', cn: '待在室内' },
          { en: 'stop', cn: '停止' },
          { en: 'take a deep breath', cn: '深呼吸' },
          { en: 'take less food', cn: '少拿点食物' },
          { en: 'take too much food', cn: '拿太多食物' },
          { en: 'take turns to talk', cn: '轮流交谈' },
          { en: 'talk it out', cn: '谈话和解' },
          { en: 'team', cn: '团队' },
          { en: 'their', cn: '他们的' },
          { en: 'think about it more', cn: '多考虑一下' },
          { en: 'throw', cn: '扔，抛' },
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'very busy at work', cn: '工作很忙' },
          { en: 'wait', cn: '等待' },
          { en: 'wait a few days', cn: '等几天' },
          { en: 'warm up', cn: '热身' },
          { en: 'waste', cn: '垃圾；浪费' },
          { en: 'watch', cn: '观察；看' },
          { en: 'wear the right shoes', cn: '穿合适的鞋子' },
          { en: 'why', cn: '为什么' },
          { en: 'will', cn: '将要；会' },
          { en: 'with', cn: '和…… 一起' },
          { en: 'without', cn: '没有' },
    ...
    children: [
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'pen', cn: '钢笔' },
          { en: 'glass', cn: '玻璃' },
          { en: 'what should ido', cn: '我应该怎么做?' },
          { en: 'pictures', cn: '用图片' },
          { en: 'look them up in the dictionary', cn: '查字典' },
          { en: 'use them in stories', cn: '在故事中使用它们' },
      ...
      },
      {
        ...
        words: [
          ...
          { en: 'football club', cn: '一个足球社团' },
          { en: 'i mind', cn: '记住' },
          { en: 'speech club', cn: '一个演讲社团' },
          { en: 'make more friends', cn: '交更多的朋友' },
          { en: 'share myideas', cn: '分享我的观点' },
          { en: 'study together', cn: '一起学习' },
          { en: 'grow taller and stronger', cn: '长得更高更壮' },
          { en: 'get some food', cn: '吃点东西' },
          { en: 'that must be hard.', cn: '那一定很难' },
          ...
          { en: 'rain', cn: '大雨' },
          { en: 'stay away from trees', cn: '远离树木' },
          { en: 'turn off the lights', cn: '关灯' },
          { en: 'close the windows', cn: '关窗户' },
          ...
          { en: 'the moon and the stars', cn: '月亮和繁星' },
          { en: 'check in', cn: '登记入住' },
          { en: 'spacewalk', cn: '太空行走' },
          { en: 'watch the sunrise', cn: '看日出' },
          { en: 'talk to astronauts', cn: '与宇航员交谈' },
          { en: 'make a bird feeder', cn: '做一个喂鸟器' },
          { en: 'find an old potato', cn: '找一个老土豆' },
          { en: 'i into the soil', cn: '放进土里' },
          { en: 'put food inside', cn: '把食物放进去' },
          { en: 'water the plant', cn: '给植株浇水' },
          { en: 'place it on a tree', cn: '把它放在树上' },
          { en: 'the lines', cn: '沿着线剪切' },
          { en: 'plastic bottle', cn: '一个用过的塑料瓶' },
          { en: 'cutitin half', cn: '把它对半切开' },
